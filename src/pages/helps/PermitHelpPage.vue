...
q-page.page(padding)
  ...
  div.fit.column.wrap.justify-center.items-center.content-center.text-center(v-if="screenWidth <= 500")
    span.main-title2.center-text Permit Details Guide
    ...
    section.step.fit.column.wrap.justify-center.items-center.content-center
      ...
      span.details At selection menu, choose the "Permit Details"
      //- span.details-extra as demonstated below
      picture
    ...
    section.step.fit.column.wrap.justify-center.items-center.content-center
      ...
      picture
        source(srcset="../../assets/images/mobile/permit-mobile4.avif" type="image/avif")
        img.image(src="../../assets/images/mobile/permit-mobile4.webp" type="image/webp" alt="Application search image")

    section.step.fit.column.wrap.justify-center.items-center.content-center
      span.details Details completely rendered
      //- span.details-extra as seen below
      picture
        source(srcset="../../assets/images/mobile/permit-mobile5.avif" type="image/avif")
        img.image(src="../../assets/images/mobile/permit-mobile5.webp" type="image/webp" alt="Application search image")
  ...
  div.fit.column.wrap.justify-center.items-center.content-center(v-if="screenWidth > 767")
    h3.main-title2.center-text Permit Details Guide
    ...
    section.step
      div.grid
        ...
        div.grid-right
          picture.fit.column.wrap.justify-center.items-center.content-center
            source(srcset="../../assets/images/pc/permit4.avif" type="image/avif")
            img.image(src="../../assets/images/pc/permit4.webp" type="image/webp" alt="Application search image")
    ...
    section.step
      div.grid
        ...
        div.grid-left
          picture.fit.column.wrap.justify-center.items-center.content-center
            source(srcset="../../assets/images/pc/permit5.avif" type="image/avif")
            img.image(src="../../assets/images/pc/permit5.webp" type="image/webp" alt="Application search image")
